...
extension $FunctionP7Extension<R, P1, P2, P3, P4, P5, P6, P7> on R Function(P1, P2, P3, P4, P5, P6, P7) {
  R invoke(P1 p1, P2 p2, P3 p3, P4 p4, P5 p5, P6 p6, P7 p7) => this(p1, p2, p3, p4, p5, p6, p7);
}

extension $FunctionP8Extension<R, P1, P2, P3, P4, P5, P6, P7, P8> on R Function(P1, P2, P3, P4, P5, P6, P7, P8) {
  R invoke(P1 p1, P2 p2, P3 p3, P4 p4, P5 p5, P6 p6, P7 p7, P8 p8) => this(p1, p2, p3, p4, p5, p6, p7, p8);
}

extension $FunctionP9Extension<R, P1, P2, P3, P4, P5, P6, P7, P8, P9> on R Function(P1, P2, P3, P4, P5, P6, P7, P8, P9) {
  R invoke(P1 p1, P2 p2, P3 p3, P4 p4, P5 p5, P6 p6, P7 p7, P8 p8, P9 p9) => this(p1, p2, p3, p4, p5, p6, p7, p8, p9);
}
